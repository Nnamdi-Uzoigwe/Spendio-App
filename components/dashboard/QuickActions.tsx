    ...
    return (
        <div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
                {/* Add Income */}
                <Link href="/dashboard/add/addIncome" className="border border-gray-300 active:opacity-0 rounded-lg p-3">   
                ...
                {/* Add Expense */}
                <Link  href="/dashboard/add/addExpense" className="border border-gray-300 active:opacity-0 rounded-lg p-3">
                ...
                {/* Scan Bill */}
                <Link  href="/dashboard/add/scanBill" className="border border-gray-300 active:opacity-0 rounded-lg p-3">
                ...
                {/* Add Task */}
                <Link  href="/dashboard/add/addTask" className="border border-gray-300 active:opacity-0 rounded-lg p-3">
